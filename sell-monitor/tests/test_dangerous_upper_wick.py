...
class DangerousUpperWickTest(unittest.TestCase):
    def test_counts_two_dangerous_upper_wicks_and_records_bar_time(self) -> None:
        ...
        self.assertIn("first_dangerous_upper_wick", signal_map)
        self.assertIn("second_dangerous_upper_wick", signal_map)
        self.assertIn("12:30", signal_map["first_dangerous_upper_wick"].reason)
        self.assertIn("13:00", signal_map["second_dangerous_upper_wick"].reason)
